...
private fun compressImageData(bitmap: ImageBitmap, usePng: Boolean): ByteArrayOutputStream {
...
actual fun ImageBitmap.addLogo(): ImageBitmap = asAndroidBitmap().applyCanvas {
  ...
  val logo = androidAppContext.resources.getDrawable(R.mipmap.icon_foreground, null).toBitmap()
